    ...
    <main class="h-screen w-full overflow-hidden bg-no-repeat">
        <nav class="flex justify-between w-full py-12 px-56">
            ...
            <div class="content flex items-center flex-row gap-2">
                ...
                <NavLink href="" action={() => {notify("Rejoindre une session","","normal",0,"box","middle",true,"Entrer le code de session",() => {window.location.href ="/quiz/"},"session")}}>Rejoindre une session</NavLink>
        ...
        <div class="contenu flex flex-row relative px-56 pt-8 gap-100">
            ...
            <div class="bg-[#FBFBFB] w-[48.75rem] h-[44rem] rounded-lg p-8">
                <div class="flex flex-row rounded-lg bg-[#F2F2F2] justify-between p-4">
                    ...
                    <div class="w-0.5 h-[2.75rem] bg-[#C5C5C5]"></div>
                    <button class="text-[1.25rem] text-black px-8 rounded-lg transition {index === "Informations personnelles" ? "bg-[#34FFAD]" : "bg-transparent"}" on:click={() => index = "Informations personnelles"}>Informations personnelles</button>
                </div>
